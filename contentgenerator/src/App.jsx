...
function App() {
  ...
  const handleGenerate = () => {
    axios(
      `https://content-generator-rl8hm1f5c-biswajit2595.vercel.app/generate?prompt=${query}`
    )
      .then((res) => {
        // console.log(res);
  ...
  const handleAnalysis = () => {
    axios.post(
      `https://content-generator-rl8hm1f5c-biswajit2595.vercel.app/analyse`,{query}
    )
      .then((res) => {
        // console.log(res);
        setResponse(res.data);
  ...
  const handleSummary = () => {
    axios
      .post(
        `https://content-generator-rl8hm1f5c-biswajit2595.vercel.app/summarize`,
        { query }
      )
      .then((res) => {
        setResponse(res.data);
  ...
  const handleTranslate = () => {
    ...
    axios
      .post(
        `https://content-generator-rl8hm1f5c-biswajit2595.vercel.app/translate`,
        request
      )
      .then((res) => {
        setResponse(res.data);
